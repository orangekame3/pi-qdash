...
`qdash_dashboard` and `qdash_triage_overview` provide compact text output for non-interactive runs and custom TUI renderers for nicer interactive tool results.
